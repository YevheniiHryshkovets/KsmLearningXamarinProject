...
namespace DesctopKSMClient.Views.TestPages
{
    ...
    public partial class SecondTestPage : ContentPage
    {
        ...
        public SecondTestPage()
        {
            ...
            {
                FirstQuestThirdButton, SecondQuestThirdButton, ThirdQuestThirdButton, FourthQuestFourthButton, FifthQuestFourthButton,
                SixthQuestSecondButton, SeventhQuestSecondButton, EighthQuestSecondButton, NinthQuestFourthButton, TenthQuestSecondButton
            };
            Result(buttons);
        }
        ...
        private async void finishTestButton_Clicked(object sender, EventArgs e)
        {
            ...
            if ((DateTime.Now - startTime).Minutes < 12)
            {
                try
                {
                    ...
                    message.Body = "Результат проходження теста Основи мережного з'єднання = " + result + "/10 ім'я студента: " + User.UserName + " з групи " + User.GroupName;
                ...
                catch
                {
                    ...
                    Answer answer = new Answer
                    {
                        ...
                        testName = "Основи мережного з'єднання",
