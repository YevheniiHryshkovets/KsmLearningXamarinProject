...
namespace DesctopKSMClient.Views.TestPages
{
    ...
    public partial class ThirdTestPage : ContentPage
    {
        public List<Button> buttons { get; set; }
        public MailAddress adminMail = new MailAddress("ksmappsender@gmail.com");
        public MailAddress senderMail = new MailAddress("networkapphome@gmail.com");
        ...
        public ThirdTestPage()
        {
            ...
            {
                FirstQuestFirstButton, SecondQuestFirstButton, ThirdQuestThirdButton, FourthQuestFirstButton, FifthQuestFourthButton,
                SixthQuestThirdButton, SeventhQuestSecondButton, EighthQuestThirdButton, NinthQuestThirdButton, TenthQuestFirstButton
            };
            Result(buttons);
        }
        ...
        private async void finishTestButton_Clicked(object sender, EventArgs e)
        {
            ...
            if ((DateTime.Now - startTime).Minutes < 12)
            {
                try
                {
                    ...
                    message.Body = "Результат проходження теста Ethernet-концепції = " + result + "/10 ім'я студента: " + User.UserName + " з групи " + User.GroupName;
