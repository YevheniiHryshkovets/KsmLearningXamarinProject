...
namespace DesctopKSMClient.Views.TestPages
{
    ...
    public partial class FifthTestPage : ContentPage
    {
        ...
        public MailSender messageSender = new MailSender();
        public FifthTestPage()
        {
            InitializeComponent();
            ...
            {
                FirstQuestSecondButton, SecondQuestThirdButton, ThirdQuestFirstButton, FourthQuestSecondButton, FifthQuestSecondButton,
                SixthQuestThirdButton, SeventhQuestThirdButton, EighthQuestFirstButton, NinthQuestFourthButton, TenthQuestFourthButton
            };
            Result(buttons);
        }
        ...
        private async void finishTestButton_Clicked(object sender, EventArgs e)
        {
            ...
            if ((DateTime.Now - startTime).Minutes < 12)
            {
                try
                {
                    //messageSender.SendMessage(Result(buttons).ToString(), "dsfsd");
                    ...
                    message.Body = "Результат проходження теста Взаємодія мережних застосунків = " + result + "/10 ім'я студента: " + User.UserName + " з групи " + User.GroupName;
                ...
                catch
                {
                    ...
                    Answer answer = new Answer
                    {
                        ...
                        testName = "Взаємодія мережних застосунків",
