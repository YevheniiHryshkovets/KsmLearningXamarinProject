...
namespace DesctopKSMClient.Views.TestPages
{
    ...
    public partial class FourthTestPage : ContentPage
    {
        ...
        public FourthTestPage()
        {
            ...
            {
                FirstQuestFirstButton, SecondQuestFirstButton, ThirdQuestFirstButton, FourthQuestFourthButton, FifthQuestFirstButton,
                SixthQuestThirdButton, SeventhQuestFourthButton, EighthQuestSecondButton, NinthQuestThirdButton, TenthQuestThirdButton
            };
            Result(buttons);
        }
        ...
        private async void finishTestButton_Clicked(object sender, EventArgs e)
        {
            ...
            if ((DateTime.Now - startTime).Minutes < 12)
            {
                try
                {
                    ...
                    message.Body = "Результат проходження теста Взаємодія між мережами = " + result + "/10 ім'я студента: " + User.UserName + " з групи " + User.GroupName;
                ...
                catch
                {
                    ...
                    Answer answer = new Answer
                    {
                        ...
                        testName = "Взаємодія між мережами",
